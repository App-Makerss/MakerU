...
struct KeychainItem {
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(service: "bgpv.academyChallenge.MakerU", account: "userIdentifier").readItem()
    ...
    static func deleteUserIdentifierFromKeychain() {
        do {
            try KeychainItem(service: "bgpv.academyChallenge.MakerU", account: "userIdentifier").deleteItem()
        } catch {
